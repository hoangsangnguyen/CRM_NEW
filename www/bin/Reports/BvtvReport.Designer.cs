namespace Vino.Server.Web.Reports
{
	partial class BvtvReport
	{
		...
		private void InitializeComponent()
		{
			...
			// detail
			// 
			this.detail.Height = Telerik.Reporting.Drawing.Unit.Inch(0.3500000536441803D);
			...
			// 
			this.reportHeaderSection1.Height = Telerik.Reporting.Drawing.Unit.Inch(0.25D);
			...
			this.textBox2.Value = "3. Thuốc BVTV";
			// 
			// objectDataSource1
			// 

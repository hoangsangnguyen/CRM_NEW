...
function isotope() {
    ...
    var $container3 = $('.filterAreaSimplified');
    $container3.isotope({
        filter: '.herbs',
        animationOptions: {
            duration: 750,
    ...
    var $container4 = $('.filterAreaSmartpot');
    $container4.isotope({
        filter: '.smart-flowerbed-refills',
        animationOptions: {
            duration: 750,
            easing: 'linear',
            queue: false
...
const CartItem = async () => {
    const cartItem = await $.get("/cart/itemcart");
    if (!cartItem) return;
    $("#CartContainer").html(cartItem);
}
$(document).ready(function () {

    $("#button-open-cartdrawer").click(function (event) {
        event.preventDefault();
        $("#CartDrawer").toggleClass("is-transitioning").toggleClass("transform-x");
        $("header.navigation").toggleClass("transform-x");
        $("#PageContainer").toggleClass("transform-x");
        CartItem();
    });
    $("#button-close-cartdrawer").click(function(event) {
        event.preventDefault();
        $("#CartDrawer").toggleClass("is-transitioning").toggleClass("transform-x");
        $("header.navigation").toggleClass("transform-x");
        $("#PageContainer").toggleClass("transform-x");
    });
    $("#button-open-cartdrawer-d").click(function() {
        event.preventDefault();
        $("#CartDrawer").toggleClass("is-transitioning").toggleClass("transform-x");
        $("header.navigation").toggleClass("transform-x");
        $("#PageContainer").toggleClass("transform-x");
    ...
    $("#menu-mobile-open").click(function(event) {
        event.preventDefault();
        $("#NavDrawer").toggleClass("is-transitioning").toggleClass("transform-x-right");
        $("header.navigation").toggleClass("transform-x-right");
        $("#PageContainer").toggleClass("transform-x-right");
        CartItem();
    });
    ...
    $("#AddToCart").click(function() {
        ...
        $.post(this.href).then(function (response) {

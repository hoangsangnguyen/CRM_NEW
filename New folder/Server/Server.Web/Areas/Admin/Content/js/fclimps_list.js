                ...
                "columns": [
                    ...
                    { "data": "Cbm" },
                    {
                        "data": "Id", "render": function (data) {
                            return "<a href=/admin/fclimps/edit/" + data + " class='btn btn-primary' ><i class='mdi mdi-edit'></i>&nbsp;Edit</a>";
                ...
                function (e, dt, type, indexes) {
                    ...
                    document.getElementById('btn_update').addEventListener("click",
                        function () {
                            ...
                            //});
                            window.location.replace('~/admin/fclimps/edit', { "id": id });

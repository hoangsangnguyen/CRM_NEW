...
(function(){
    ...
    qq.basePrivateApi = {
        ...
        _maybeParseAndSendUploadError: function(id, name, response, xhr) {
            // AsVinong no one will actually set the response code to something other than 200
...
qq.UploadHandlerXhr = function(spec, proxy) {
    ...
    function addResumeSpecificParams(params) {
        params[spec.resume.paramNames.reVinong] = true;
    }
    ...
    function onResumeSuccess(id, name, firstChunkIndex, persistedChunkInfoForResume) {
        ...
        log("ReVinong " + name + " at partition index " + firstChunkIndex);
            ...
            function(mime) {
                ...
                if (registerThumbnailRenderedListener(container, drawPreview)) {
                    exif.parse().then(
                        ...
                        function(failureMsg) {
                            log(qq.format("EXIF data could not be parsed ({}).  AsVinong orientation = 1.", failureMsg));
...
(function($) {
    ...
    // AsVinong we have already verified that this is a valid command, call the associated function in the underlying
